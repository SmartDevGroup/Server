...
<html lang="en" dir="ltr">
  ...
  <body>
                ...
                <nav class="navbar navbar-transparent">
                  <div class="container-fluid">
                      ...
                      <div class="col text-center">
                        <h1 class="text-light" id="date_time"> </h1>
                        <h2 class="text-light"><img src='images/stove.png'> Kitchen</h2>
                      </div>
                  </div>
                </nav>
                <div class="row">
    ...
    {
      $.ajax({
      url: 'chart/chart_kitchen.php',
      cache: false,
      success: function(json_temp){
        var data = JSON.parse(json_temp);
        sum = data.sum;
        if(sum == 1){yValue1 = parseInt(data.k_s_1); yValue2 = "Disabled";  yValue3= "Disabled"; yValue4 = "Disabled"; yValue5 = "Disabled"; yValue6 = "Disabled";}
        if(sum == 2){yValue1 = parseInt(data.k_s_1); yValue2 = parseInt(data.k_s_2); yValue3= "Disabled"; yValue4 = "Disabled"; yValue5 = "Disabled"; yValue6 = "Disabled";}
        if(sum == 3){yValue1 = parseInt(data.k_s_1); yValue2 = parseInt(data.k_s_2);  yValue3= parseInt(data.k_s_3); yValue4 = "Disabled"; yValue5 = "Disabled"; yValue6 = "Disabled";}
        if(sum == 4){yValue1 = parseInt(data.k_s_1); yValue2 = parseInt(data.k_s_2);  yValue3= parseInt(data.k_s_3); yValue4 = parseInt(data.k_s_4); yValue5 = "Disabled"; yValue6 = "Disabled";}
        if(sum == 5){yValue1 = parseInt(data.k_s_1); yValue2 = parseInt(data.k_s_2);  yValue3= parseInt(data.k_s_3); yValue4 = parseInt(data.k_s_4); yValue5 = parseInt(data.k_s_5); yValue6 = "Disabled";}
        if(sum == 6){yValue1 = parseInt(data.k_s_1); yValue2 = parseInt(data.k_s_2);  yValue3= parseInt(data.k_s_3); yValue4 = parseInt(data.k_s_4); yValue5 = parseInt(data.k_s_5); yValue6 = parseInt(data.k_s_6)}
