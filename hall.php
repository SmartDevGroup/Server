                        ...
                        <tbody>
                          ...
                          for ($i=1; $i <= $Sum ; $i++) {
                            echo "<tr>
                              ...
                              <td><div class='semitext' id='h_conn_$i'></div></td>
                              <td><div class='semitext' id='h_stan_$i'></div></td>
                              <td><h4 id='name_home_$i'></h4></td>
                              <td><div class='btn btn-block semibutt'><img src='images/socket.png'> <input type='checkbox' data-width='90%' class='text-center' data-toggle='toggle' data-on='ON' data-off='Off ' data-onstyle='success' data-offstyle='danger' name='status' id='home_socket_$i' value='0'></div></td>
                            </tr>";
                          } ?>
                        </tbody>
                      </table>
                    ...
                    <div class="card">
                      <div class="card-body ">
                        ...
                        <div class="card text-center">
                          ...
                          <h5 class="card-title"><div class="semitext" id='h_stan_l'></div></h5>
                          <div class="btn btn-block semibutt text-center"><input type='checkbox' data-width='60%' class='text-center' data-toggle='toggle' data-on='ON' data-off='Off ' data-onstyle='success' data-offstyle='danger' name='status' id='home_light' value='0'>
                          </div>
                          <br>
