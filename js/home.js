...
function name()
{
  ...
  success: function(json_n){
    ...
    $('#name_home_1').text(data.b_s_1);
    $('#name_home_2').text(data.b_s_2);
    $('#name_home_3').text(data.b_s_3);
    $('#name_home_4').text(data.b_s_4);
    $('#name_home_5').text(data.b_s_5);
    $('#name_home_6').text(data.b_s_6);
  }
  });
}
