...
$update_bedroom_name = mysqli_query($link, "UPDATE bedroom SET name_sock_1= '$arr[name_1]', name_sock_2= '$arr[name_1]', name_sock_3= '$arr[name_3]', name_sock_4= '$arr[name_4]', name_sock_5= '$arr[name_5]', name_sock_6= '$arr[name_6]' WHERE api_key='$get_key'");
