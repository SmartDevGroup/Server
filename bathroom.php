                        ...
                        <tbody>
                          ...
                          for ($i=1; $i <= $Sum ; $i++) {
                            echo "<tr>
                              ...
                              <td><div class='btn btn-block semibutt'><img src='images/socket.png'> <input type='checkbox' data-width='60%' class='text-center' data-toggle='toggle' data-on='ON' data-off='Off ' data-onstyle='success' data-offstyle='danger' name='status' id='bathroom_socket_$i' value='0'></div></td>
                            </tr>";
                          } ?>
                          <th scope='row'><i class="fas fa-lightbulb"></i></th>
                          <td><h3 class='text-primary'>-</h3></td>
                          <td><div class='semitext' id='ba_stan_l'></div></td>
                          <td></td>
                          <td><div class="btn btn-block semibutt"><img src='images/light.png'> <input type='checkbox' data-width='60%' class='text-center' data-toggle='toggle' data-on='ON' data-off='Off ' data-onstyle='success' data-offstyle='danger' name='status' id='bathroom_light' value='0'></div></td>
                        </tr>
                        </tbody>
                      </table>
                  </div>
