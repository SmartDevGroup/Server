...
//mysqli_query($link, "UPDATE bathroom SET l_ba = l_ba + 1 WHERE api_key = '$get_key'");
if($get_key == ""){header("Location: http://smartdevgroup.hopto.org/");}
  include 'status/bathroom_sum.php';
?>
...
<html lang="en" dir="ltr">
  ...
  <body>
                  ...
                  <li class="active">
                      <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle text-center"><i class="fas fa-home"></i> Home</a>
                        <ul class="collapse list-unstyled" id="homeSubmenu">
                          ...
                          <li>
                              <a href="#"><i class="fas fa-shower"></i> Bathroom</a>
                          </li>
                          <li>
                ...
                <nav class="navbar navbar-transparent">
                  <div class="container-fluid">
                      ...
                      <div class="col text-center">
                        ...
                        <h2 class=""><img src='images/bath.png'> Bathroom</h2>
                      </div>
                  </div>
                </nav>
                <div class="row">
                    ...
                    <table class="table table-light text-center">
                        ...
                        <tbody>
                          ...
                          for ($i=1; $i <= $Sum ; $i++) {
                            echo "<tr>
                              <th scope='row'>$i</th>
                              <td><h3 class='text-primary' id='ba_temp_$i'></h3></td>
                              <td><div class='semitext' id='ba_conn_$i'></div></td>
                              <td><div class='semitext' id='ba_stan_$i'></div></td>
                              <td><h4 id='name_bathroom_$i'></h4></td>
                              <td><div class='btn btn-block semibutt'><img src='images/socket.png'> <input type='checkbox' data-width='90%' class='text-center' data-toggle='toggle' data-on='ON' data-off='Off ' data-onstyle='success' data-offstyle='danger' name='status' id='bathroom_socket_$i' value='0'></div></td>
                            </tr>";
                          } ?>
                        </tbody>
                      </table>
                    ...
                    <div class="card">
                      <div class="card-body ">
                        ...
                        <div class="card text-center">
                          ...
                          <h5 class="card-title"><div class="semitext" id='ba_stan_l'></div></h5>
                          <div class="btn btn-block semibutt text-center"><input type='checkbox' data-width='60%' class='text-center' data-toggle='toggle' data-on='ON' data-off='Off ' data-onstyle='success' data-offstyle='danger' name='status' id='bathroom_light' value='0'>
                          </div>
                          <br>
    ...
    {
      $.ajax({
      url: 'chart/chart_bathroom.php',
      cache: false,
      success: function(json_temp){
        var data = JSON.parse(json_temp);
        sum = data.sum;
        if(sum == 1){yValue1 = parseInt(data.ba_s_1); yValue2 = "Disabled";  yValue3= "Disabled"; yValue4 = "Disabled"; yValue5 = "Disabled"; yValue6 = "Disabled";}
        if(sum == 2){yValue1 = parseInt(data.ba_s_1); yValue2 = parseInt(data.ba_s_2); yValue3= "Disabled"; yValue4 = "Disabled"; yValue5 = "Disabled"; yValue6 = "Disabled";}
        if(sum == 3){yValue1 = parseInt(data.ba_s_1); yValue2 = parseInt(data.ba_s_2);  yValue3= parseInt(data.ba_s_3); yValue4 = "Disabled"; yValue5 = "Disabled"; yValue6 = "Disabled";}
        if(sum == 4){yValue1 = parseInt(data.ba_s_1); yValue2 = parseInt(data.ba_s_2);  yValue3= parseInt(data.ba_s_3); yValue4 = parseInt(data.ba_s_4); yValue5 = "Disabled"; yValue6 = "Disabled";}
        if(sum == 5){yValue1 = parseInt(data.ba_s_1); yValue2 = parseInt(data.ba_s_2);  yValue3= parseInt(data.ba_s_3); yValue4 = parseInt(data.ba_s_4); yValue5 = parseInt(data.ba_s_5); yValue6 = "Disabled";}
        if(sum == 6){yValue1 = parseInt(data.ba_s_1); yValue2 = parseInt(data.ba_s_2);  yValue3= parseInt(data.ba_s_3); yValue4 = parseInt(data.ba_s_4); yValue5 = parseInt(data.ba_s_5); yValue6 = parseInt(data.ba_s_6)}
